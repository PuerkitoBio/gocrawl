...
func runWithOptions(opts *Options, urlSel []string, seeds []string) (spyv *visitorSpy, spyu *urlSelectorSpy, b *bytes.Buffer) {
...
func TestFileFetcherAllSameHost(t *testing.T) {
	...
	spyv, spyu, _ := runWithOptions(opts, []string{"?"}, []string{"http://hosta/page1.html", "http://hosta/page4.html"})

	assertCallCount(spyv, 5, t)
	assertCallCount(spyu, 13, t)
}

func TestFileFetcherAllNotSameHost(t *testing.T) {
	opts := NewOptions(nil, nil)
