# gocrawl [![Go Reference](https://pkg.go.dev/badge/github.com/PuerkitoBio/gocrawl.svg)](https://pkg.go.dev/github.com/PuerkitoBio/gocrawl) [![build status](https://secure.travis-ci.org/PuerkitoBio/gocrawl.png)](http://travis-ci.org/PuerkitoBio/gocrawl)
